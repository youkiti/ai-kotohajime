...
- You can take the quiz even without having read [Unit A-1](../units/a1.md) or [Unit A-2](../units/a2.md). The only requirement for passing is answering correctly on the quiz.
